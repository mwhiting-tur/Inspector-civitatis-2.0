...
# --- CONFIGURACIÓN ---
archivo_entrada = 'gyg/tours_peru_IDs.csv'
archivo_salida = 'gyg/reviews_peru_FINAL.csv'
    ...
    while continuar_paginando:
        ...
        try:
            ...
            for review in reseñas:
                ...
                linea_csv = f"Perú;{destino};{actividad};{url_act};{fecha_obj.strftime('%d/%m/%Y')};{pais_usuario}\n"
